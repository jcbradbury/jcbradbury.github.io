...
Because of the shared funding burden, stadium projects are often referred to as "public-private partnerships." Though it may seem to be an appropriate description of the relationship due to the joint nature of the project, the moniker is misleading, as it implies that the government is contributing to a profit-making venture that is expected to return positive net revenue for both the team tenant and taxpayers. However, when it comes to stadium projects, the financial arrangements operate differently. 

 *Business* partnerships typically involve investments from private partners whose expected future revenue returns are commensurate with the size of each party's financial stake in the project. For example, an investor who covers 30% of the cost of the project expects to receive 30% of the future profits. Stadium partnerships normally involve a public funding contribution, while the private team partner receives 100% of the revenue.  The so-called "returns" to the public are hypothesized to be derive from subsequent economic activity created by the stadium, which will generate sufficient tax receipts to more than cover the cost of the taxpayer contribution. However, in practice this does not happen, as decades of economics research consistently demonstrates that [sports venues have limited to no economic impacts](/stadium-economic-impact/). 
