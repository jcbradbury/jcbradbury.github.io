...
Because governments have the power to tax, they are considered generally good credit risks, which allows them to issue bonds at lower interest rates than private borrowers. Some municipal bonds are exempt from federal taxation, which lowers borrowing costs further and represents [another form of subsidy that sports teams often receive](/stadium-costs/#what-costs-are-commonly-omitted-from-stadium-subsidy-estimates). However, to preserve the tax exemption for bonds financing privately used stadiums, no more than 10% of the debt service generally can be derived from or secured by private-use property or payments. This is why stadiums financed with tax-exempt bonds are often repaid with tax revenues rather than stadium-generated revenues. [The IRS explains the private security or payment test here](https://www.irs.gov/tax-exempt-bonds/private-business-use-management-contracts).
...
Most municipal jurisdictions assess property taxes that go into a general fund to support basic government operations. When local governments began building stadiums, they often drew from the general fund to cover the expenses, with local property owners picking up the tab to service the bond debt. 

Different tax jurisdictions tend to assess property taxes in their own way, but the taxes collected normally reflect the value of the property. An attribute of property taxes funding the local government is that it reflects the added value of public amenities. For example, a home located in a city with nice parks and good schools will tend to attract more residents, which results to higher property values. This translates into greater revenue flowing to the jurisdiction, which may allow it to fund other local projects or lower the tax rate needed to maintain its provided services. Thus, if hosting a sports team in a public venue is something that most residents value, then it should be reflected in the increased value of property tax assessments. Economists have looked for this effect, and the evidence is mixed---[studies have found positive, negative, and no effect](/stadium-economic-impact/#do-stadiums-increase-nearby-property-values)---which suggests that the amenity value of having a hometown team is low. 

Property tax increases often require  voter approval, and thus elected officials began to turn to other taxes to fund stadium projects. This has the advantage of not risk being rejected by voters, and it relies on other mechanisms whose costs are not as transparent as the line on a property tax bill.  
