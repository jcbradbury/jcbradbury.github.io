...
Because governments have the power to tax, they are considered generally good credit risks, which allows them to issue bonds at lower interest rates than private borrowers. Some municipal bonds are exempt from federal taxation, which lowers borrowing costs further, and represents [another form of subsidy that sports teams receive](/stadium-costs/#what-costs-are-commonly-omitted-from-stadium-subsidy-estimates). However, to qualify for this exemption, the bonds must be repaid from sources not generated by the stadium, which is why stadiums are often funded without tax exempt bonds. 
