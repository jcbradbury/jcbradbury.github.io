...
Because of the shared funding burden, stadium projects are often referred to as "public-private partnerships." Though it may seem to be an appropriate description of the relationship due to the joint nature of the project, the moniker is misleading. The term "partnership" implies that the government is participating in a *business* partnership, which typically involves investments from private partners who expect to received a share of future income, which which is commensurate with the size of its financial contribution. For example, an investor who covers 30% of the cost of the project expects to receive 30% of the future profits. 


However, when it comes to stadium projects, the financial arrangements operate differently from standard business partnerships.  The public-private relationship includes the public funding contribution without granting rights to future income that flows from the project--- the private team partner is entitled to 100% of the revenue.  Instead, the so-called "returns" to the public supposedly derive from sequent economic activity that the stadium hypothetically creates, which is assumed to generate sufficient tax receipts to more than cover the cost of the taxpayer contribution. However, in practice this does not happen, as decades of economics research consistently demonstrates that [sports venues have limited to no economic impacts](/stadium-economic-impact/). 

contributing to a profit-making venture that is expected to return positive net revenue for both the team tenant and taxpayers. 
