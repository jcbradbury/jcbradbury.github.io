...
Most municipal jurisdictions use property taxes that go into a general fund to support its operations. When local governments began building stadiums, they often drew from the general funds to cover the expenses, with local property owners picking up the tab to service the bond debt. 
