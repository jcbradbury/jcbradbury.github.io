...
My book **This One Will Be Different: False Promises and Fiscal Realities of Publicly Funded Stadiums** is scheduled to be released on October 9. <!-- 
...
<div style="display: flex; align-items: flex-start; gap: 20px; flex-wrap: wrap;">
  ...
  <div style="flex: 1;">
    <ul>
      ...
      <li><a href="https://play.google.com/store/books/details/J_C_Bradbury_This_One_Will_Be_Different?id=wLzwEQAAQBAJ">Google Play</a> (available now)</li>   
      ...
      <li>Journalists/course instructors seeking a review copy:</li> 
        <ul>
        <li>Click <a href="https://academic.oup.com/pages/request-a-review-copy">here;</a> ISBN: 9780197820216</li>
        </ul>
    </ul>
  </div>
