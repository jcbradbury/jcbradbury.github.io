...
_pages/stadium-economic-impact.md

Before publishing:
1. Replace or revise any text marked EDIT.
2. Check every link.
3. Make sure the FAQ structured data at the bottom matches the visible answers.
...
I've written quite a bit on the economics of professional sports venues, especially relating to their public financing. It's the subject of my recent book [*This One Will Be Different*](/towbd/), which includes a detailed (but not complex) review of the subject. This page provides a more general summary the major findings of economic research, explains common misunderstandings, and offers questions journalists and policymakers should ask when evaluating stadium proposals. I include links to relevant research that you can investigate further. 

> **The key takeaway:** Most professional sports stadiums do not produce meaningful net economic growth for their host communities. Stadiums can create visible activity near a venue and generate benefits for teams, fans, nearby businesses, and property owners. But decades of economic research find that these gains are generally too small to justify the large public subsidies commonly provided for stadium construction and related development.

<!-- EDIT: Revise the introductory paragraphs below to reflect your preferred wording. -->

Local leaders and team officials often pitch sports venues as economic development projects, promising increased commercial activity that brings new jobs, increased consumer spending, higher property values, neighborhood revitalization, and additional tax revenue. Though hosted events are associated with spending in and around the venue, the relevant policy question is whether the stadium creates **net new** economic activity that would not otherwise have occurred, and if any gains exceed the full public cost.
...
Sports teams can generate real benefits that do not appear in conventional measures of income or tax revenue. Residents may value civic identity, community pride, media visibility, and the option to attend games even when they rarely visit the stadium.
